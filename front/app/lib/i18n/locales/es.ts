const es = {
  homePage: {
    ...
    aboutModal: {
      title: "Acerca de",
      description: "SkyPong es un juego de Pong 3D creado con Babylon.js. Esta es una versión simplificada con modos local IA y 2 jugadores. El proyecto completo con multijugador online, perfiles de jugador y más está disponible en GitHub.",
      repoLink: "Ver el proyecto completo en GitHub →",
    },
  },
  user: {
    hi: ({ name, className, url }) =>
      `¡Hola, <a href="${url}" class="${className}"> ${name}</a>!`,
    nickname: "Nickname",
    ...
    deleteAccountWarning:
      "Esto eliminará tu cuenta permanentemente. Esta acción es irreversible. ¿Estás seguro?",
    typeConfirm: "Escribe",
    ...
    errors: {
      ...
      nicknameMinLength: (len: number) => {
        return `El nickname debe contener al menos ${len} caracteres`;
      },
      winphraseRequired: "Frase de victoria requerida",
      winphraseMinLength: (len: number) => {
        return `La frase de la victoria debe contener al menos ${len} caracteres`;
      },
    },
  },
  avatar: {
...
gameMode: {
    ...
    local2P: "2J Local",
    local2PDesc: "Juega contra otro jugador en el mismo teclado",
    vsAI: "vs IA",
    vsAIDesc: "Desafía a la computadora",
    easy: "Fácil",
    medium: "Medio",
    hard: "Difícil",
    ...
    yourName: "Tu nombre",
    winningScore: "Puntuación para ganar",
    player1Color: "Color Jugador 1",
    player2Color: "Color Jugador 2",
    yourPaddleColor: "Color de tu paleta",
    controls: "Controles",
    p1Controls: "J1: Teclas A/D",
    p2Controls: "J2: Teclas J/L",
    yourControls: "Tú: Teclas A/D",
    start: "Empezar",
    back: "Volver",
    local: {
      title: "1 vs 1 Local",
  ...
  game: {
    ...
    errors: {
      ...
      onlineRoleOnlyForOnlineMode:
        "Solo el modo ONLINE puede incluir onlineRole.",
  ...
  form: {
    ...
    passwordUpdateLoginAgain:
      "Contraseña actualizada. Entra de nuevo por motivos de seguridad.",
    submit: "Enviar",
  },
  leaderboard: {
  ...
  uiTest: {
    ...
    descriptions: {
      ...
      showsUserImage:
        "Muestra la imagen cargada del usuario, o la primera letra del apodo como respaldo",
    },
    designSystem: {
      ...
      componentUsage:
        "Los componentes usan CVA (class-variance-authority) para variantes seguras de tipo y utilidad cn() para fusionar className.",
    ...
    responsive: {
      ...
      resizeMsg:
        "Redimensiona tu navegador para ver los puntos de quiebre responsivos en acción.",
    },
    footer:
      "Esta es una página de prueba de desarrollo. Eliminar cuando los componentes estén implementados.",
  },
};
