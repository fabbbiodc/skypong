...
<p style="text-align: center; font-size: 0.8em;">If you’ve read this far, you clearly have too much free time. Go finish <code>Inception</code>.</p>`,
    ...
    uiTest: {
        ...
        descriptions: {
            ...
            showsUserImage: "Shows user's uploaded image, or first letter of nickname as fallback",
        },
        designSystem: {
            ...
            componentUsage: "Components use CVA (class-variance-authority) for type-safe variants and cn() utility for className merging.",
        ...
        responsive: {
            ...
            resizeMsg: "Resize your browser to see the responsive breakpoints in action.",
        },
        footer: "This is a development test page. Remove when components are implemented.",
    },
};
