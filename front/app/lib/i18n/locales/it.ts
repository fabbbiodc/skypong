const it = {
    ...
    user: {
        ...
        deleteAccountWarning: "Questo rimuoverà permanentemente il tuo account. Questa azione è irreversibile. Sei sicuro?",
        typeConfirm: "Digita",
        ...
        errors: {
            ...
            nicknameMinLength: (len: number)=>{ return (`Il nickname deve contenere almeno ${len} caratteri`)},
            winphraseRequired: "Frase di vittoria richiesta",
            winphraseMinLength: (len: number)=>{ return (`La frase di vittoria deve contenere almeno ${len} caratteri`)},
        }
    },
    avatar: {
...
<p style="text-align: center; font-size: 0.8em;">Se hai letto fino a qui, hai decisamente troppo tempo libero. Vai a finire <code>Inception</code>.</p>`,
    ...
    uiTest: {
        ...
        descriptions: {
            ...
            clickableAvatar: "Avatar cliccabile (passa il mouse per vedere l'effetto)",
            exampleNav: "Esempio di utilizzo nella navigazione:",
            clickToOpen: "← Clicca per aprire menu utente",
            showsUserImage: "Mostra l'immagine caricata dall'utente, o la prima lettera del nickname come riserva",
        },
        designSystem: {
            ...
            componentUsage: "I componenti usano CVA (class-variance-authority) per varianti type-safe e utilità cn() per unire className.",
        ...
        responsive: {
            ...
            resizeMsg: "Ridimensiona il tuo browser per vedere i punti di interruzione responsivi in azione.",
        },
        footer: "Questa è una pagina di test di sviluppo. Rimuovere quando i componenti sono implementati.",
    },
};
