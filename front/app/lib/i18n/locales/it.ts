const it = {
  homePage: {
    ...
    aboutModal: {
      title: "Informazioni",
      description: "SkyPong è un gioco di Pong 3D realizzato con Babylon.js. Questa è una versione semplificata con modalità IA locale e 2 giocatori. Il progetto completo con multiplayer online, profili giocatore e altro è disponibile su GitHub.",
      repoLink: "Scopri il progetto completo su GitHub →",
    },
  },
  user: {
  ...
  gameMode: {
    ...
    chooseHowToPlay: "Scegli come vuoi giocare",
    local2P: "2G Locale",
    local2PDesc: "Gioca contro un altro giocatore sulla stessa tastiera",
    vsAI: "vs IA",
    vsAIDesc: "Sfida il computer",
    easy: "Facile",
    medium: "Medio",
    hard: "Difficile",
    ...
    winningScore: "Punteggio per vincere",
    player1Color: "Colore Giocatore 1",
    player2Color: "Colore Giocatore 2",
    yourPaddleColor: "Colore della tua racchetta",
    controls: "Controlli",
    p1Controls: "G1: Tasti A/D",
    p2Controls: "G2: Tasti J/L",
    yourControls: "Tu: Tasti A/D",
    start: "Inizia",
    back: "Indietro",
    local: {
      title: "1 vs 1 Locale",
